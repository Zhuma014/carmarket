...
import (
	"carmarket.kz/internal/data"
	"carmarket.kz/internal/jsonlog"
	"carmarket.kz/internal/mailer"
	"context"
	"database/sql"
	"flag"
	_ "github.com/lib/pq"
...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "db-dsn", "postgres://carmarket:pa55word@localhost/carmarket?sslmode=disable", "PostgreSQL DSN")
